...
export default function FormRegistrarUsuarioEscritorio({ onSubmit }) {
    ...
    // 1️⃣ Declara tu array antes de cualquier hook que lo use
    const preguntas = [
    ...
    // Actualizar password en formData cuando cambia
    useEffect(() => {
        setFormData((prev) => ({ ...prev, password }));
    }, [password]);

    // Actualizar telefono en formData cuando cambia
    useEffect(() => {
    ...
    const handleSubmit = (e) => {
        ...
        onSubmit({
            nombre,
            email,
            telefono: `${countryCode}${phoneNumber}`,       // concat correcto
            direccion,
            documentoIdentidad,
            fechaNacimiento,
            preguntaSecreta: selectedQuestion,             // pregunta seleccionada
            respuestaSecreta,                              // respuesta escrita
            password,
        });
    };
